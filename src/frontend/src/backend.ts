...
import type { Watch as _Watch, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addWatch(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: Array<Uint8Array>, arg7: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addWatch(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCartTotal(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCartTotal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFeaturedWatches(): Promise<Array<Watch>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedWatches();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchWatches(arg0: string): Promise<Array<Watch>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchWatches(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCartItemQuantity(arg0: string, arg1: bigint, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateWatch(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string, arg6: string, arg7: Array<Uint8Array>, arg8: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateWatch(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Watch]): Watch | null {
    return value.length === 0 ? null : value[0];
}
